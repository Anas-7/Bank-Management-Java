...
public class ourproducts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("<html>Discover a wide range of products and services that suit your evolving needs.<br><br>   \n1. Fund Transfers <br><br>   \n2. Debit Card <br><br>\n3. Savings Account<br> \n> Simplest deposit option available to the depositor.<br>\n> ATM cum Debit card issued without any charge.<br>\n> Unique facility of Self User Creation.<br>\n> Account can be opened with zero balance.<br>\n> Rate of Interest: 5%<br><br>\n\n4.Current Account<br> \n> Monitor and control your funds through Internet banking.<br>\n> Transaction ease facilitated by unlimited number of payments.<br>\n> Account can be opened with zero balance.<br><br>\n\n</html>");
