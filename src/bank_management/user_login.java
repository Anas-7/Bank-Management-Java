    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            while(rs.next()){
                ...
                if(rs.getInt("customer_id")==user_id && rs.getString("customer_password").equals(password)){
                    flag=1;
                    break;
                }
            }
            if(flag==1 && rs.getString("verified").equals("yes")){
                System.out.println("Data exists.");
                //Since the account exists we will open menu of options.
                user_login_validated new_form=new user_login_validated(user_id,password);
            ...
            else if(flag==1 && rs.getString("verified").equals("no")){
                JOptionPane.showMessageDialog(user_login.this,"User ID has not been verified ny the bamk. Please contact the bank for more details.");
                jTextField1.setText(null);
                jPasswordField1.setText("");
                jTextField1.grabFocus();
            }
            else if(flag==0){
                JOptionPane.showMessageDialog(user_login.this,"Incorrect entries! Please try again");
                jTextField1.setText(null);
                jPasswordField1.setText("");
                jTextField1.grabFocus();
            }
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(user_login.this,"Empty entries! Please try again");
                jTextField1.setText(null);
                jPasswordField1.setText("");
                jTextField1.grabFocus();
        }
